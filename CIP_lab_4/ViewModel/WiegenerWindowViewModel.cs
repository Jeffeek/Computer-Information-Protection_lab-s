...
using CIP_lab_4.Model;
using GalaSoft.MvvmLight.CommandWpf;
using Microsoft.Win32;

namespace CIP_lab_4.ViewModel
{
    public class WiegenerWindowViewModel : ViewModelBase
    {
        ...
        private void SaveEncryptedFile()
        {
            ...
            var wiegener = new WiegenerAlgorithm(isEnglish);
            var text = wiegener.Encrypt(EncryptText, SecretEncrypt);
        ...
        private void OnDecryptPressed()
        {
            ...
            if (dialog.ShowDialog().Value)
            {
                ...
                using (var reader = new StreamReader(loadFile))
                {
                    ...
                    bool isEnglish = Language.Contains("English");
                    var trisemus = new WiegenerAlgorithm(isEnglish);
        ...
        public WiegenerWindowViewModel()
        {
